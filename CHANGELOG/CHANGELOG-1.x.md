...
### Added
### Changed
- **debt:** Upgraded to [sixafter/nanoid@v1.64.3](https://github.com/sixafter/nanoid/releases/tag/v1.64.3).
...
### Added
### Changed
- **debt:** Upgraded to [sixafter/nanoid@v1.64.0](https://github.com/sixafter/nanoid/releases/tag/v1.64.0).
- **debt:** Upgraded dependencies to their latest stable versions.
...
### Changed
- **debt:** Upgraded dependencies to their latest stable versions.
- **debt:** Upgraded to [Go 1.26.0](https://go.dev/doc/devel/release#go1.26.0).
- **debt:** Upgraded to [sixafter/nanoid@v1.63.1](https://github.com/sixafter/nanoid/releases/tag/v1.63.1).
...
### Changed
- **debt:** Upgraded dependencies to their latest stable versions.
- **debt:** Upgraded to [Go 1.25.6](https://go.dev/doc/devel/release#go1.25.6).
- **debt:** Upgraded to [sixafter/nanoid@v1.60.0](https://github.com/sixafter/nanoid/releases/tag/v1.60.0).
...
### Changed
- **debt:** Upgraded dependencies to their latest stable versions.
- **debt:** Upgraded to [sixafter/nanoid@v1.51.0](https://github.com/sixafter/nanoid/releases/tag/v1.51.0).
...
### Removed
### Fixed
- **defect:** Corrected macOS notarization issues by updating the notarization configuration.
...
[Unreleased]: https://github.com/sixafter/nanoid-cli/compare/v1.47.3...HEAD
...
[1.27.0]: https://github.com/sixafter/nanoid-cli/compare/v1.26.0...v1.27.0
[1.26.0]: https://github.com/sixafter/nanoid-cli/compare/v1.25.0...v1.26.0
